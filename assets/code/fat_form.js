...
var MAP_VALIDATION_ID_IDENT={};MAP_VALIDATION_ID_IDENT[VALIDATOR_CONST.VALIDATION_NONE]='__validator__none';MAP_VALIDATION_ID_IDENT[VALIDATOR_CONST.VALIDATION_NOT_EMPTY]='__validator__not_empty';MAP_VALIDATION_ID_IDENT[VALIDATOR_CONST.VALIDATION_EMAIL]='__validator__email';MAP_VALIDATION_ID_IDENT[VALIDATOR_CONST.VALIDATION_CHAR]='__validator__character';MAP_VALIDATION_ID_IDENT[VALIDATOR_CONST.VALIDATION_NUMBER]='__validator__number';MAP_VALIDATION_ID_IDENT[VALIDATOR_CONST.VALIDATION_PHONE]='__validator__phone';MAP_VALIDATION_ID_IDENT[VALIDATOR_CONST.VALIDATION_DATE]='__validator__date';MAP_VALIDATION_ID_IDENT[VALIDATOR_CONST.VALIDATION_RE]='__validator__reg_exp';VALIDATOR_CONST.VALIDATIONS_LIST={};VALIDATOR_CONST.VALIDATIONS_LIST[VALIDATOR_CONST.VALIDATION_NONE]={name:"Brez",value:VALIDATOR_CONST.VALIDATION_NONE,options:[]};VALIDATOR_CONST.VALIDATIONS_LIST[VALIDATOR_CONST.VALIDATION_NOT_EMPTY]={name:"Vnos obvezen",value:VALIDATOR_CONST.VALIDATION_NOT_EMPTY,options:[]};VALIDATOR_CONST.VALIDATIONS_LIST[VALIDATOR_CONST.VALIDATION_EMAIL]={name:"E-mail",value:VALIDATOR_CONST.VALIDATION_EMAIL,options:[]};VALIDATOR_CONST.VALIDATIONS_LIST[VALIDATOR_CONST.VALIDATION_CHAR]={name:"Besedilo",value:VALIDATOR_CONST.VALIDATION_CHAR,options:["length_from","length_to"]};VALIDATOR_CONST.VALIDATIONS_LIST[VALIDATOR_CONST.VALIDATION_NUMBER]={name:"Število",value:VALIDATOR_CONST.VALIDATION_NUMBER,options:["range_from","range_to"]};VALIDATOR_CONST.VALIDATIONS_LIST[VALIDATOR_CONST.VALIDATION_PHONE]={name:"Telefon",value:VALIDATOR_CONST.VALIDATION_PHONE,options:["phone_format"]};VALIDATOR_CONST.VALIDATIONS_LIST[VALIDATOR_CONST.VALIDATION_DATE]={name:"Datum",value:VALIDATOR_CONST.VALIDATION_DATE,options:["date_format"]};VALIDATOR_CONST.VALIDATIONS_LIST[VALIDATOR_CONST.VALIDATION_RE]={name:"Regularni izraz",value:VALIDATOR_CONST.VALIDATION_RE,options:["reg_exp"]};
...
function Validator_IsInteger_Message(){return'Potrebno je vpisati navadno število.';}
function Validator_IsPositiveInteger(vValue){return(Validator_IsInteger(vValue)&&vValue>0);}
function Validator_IsPositiveInteger_Message(){return'Potrebno je vpisati pozitivno število.';}
function Validator_IsNonNegativeInteger(vValue){return(Validator_IsInteger(vValue)&&vValue>=0);}
function Validator_IsNonNegativeInteger_Message(){return'Potrebno je vpisati pozitivno število.';}
...
function Validator_EmptyOrPositiveInteger_Message(){return'Vpišite pozitivno število ali pustite prazno polje';}
...
function Validator_EmptyOrNonNegativeInteger_Message(){return'Vpišite ne-negativno število ali pustite prazno polje.';}
...
if(oOptions.length_from&&oOptions.length_to){sMessage='Enter not less than '+oOptions.length_from+' letters.';}
...
var mapDateFormat_Data={"1":{handler:ValidDate_1,format:'LLLL-MM-DD'},"2":{handler:ValidDate_2,format:'LL-MM-DD'},"3":{handler:ValidDate_3,format:'DD-MM-YYYY'},"4":{handler:ValidDate_4,format:'DD-MM-YY'}}
